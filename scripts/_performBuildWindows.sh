...
# Universal Windows Build Script
# Target: Windows x64 (.NET 8.0+)
...
OUTPUT_ZIP="$OUTPUT_DIR/${SOLUTION_NAME}.Windows.zip"
PLATFORM="windows"
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    -o|--output)
      OUTPUT_DIR="$2"; BUILD_DIR="$OUTPUT_DIR/net10.0"; OUTPUT_ZIP="$OUTPUT_DIR/${SOLUTION_NAME}.Windows.zip"; shift 2 ;;
    -h|--help)
